		...
		<div class="mb-6">
			...
			<div class="space-y-2">
				{#each selected.subProjects as subproject}
					<div
						class="rounded-lg border border-info/20 bg-background/40 p-3 transition-all duration-150 hover:border-info/40"
					>
						<button
						...
						{#if expandedSubprojects.includes(subproject.name)}
							<div class="mt-3 space-y-2 border-t border-info/10 pt-3">
